...
contract SUPCool is ERC721URIStorage, VRFConsumerBase {
    ...
    // address[] public owners; //for multi-sign
    // uint56 private requiredApprovals; //for multi-sign
    // mapping(address => bool) private isSigner; //for multi-sign
    // mapping(uint256 => mapping(address => bool)) private isApproved; //for multi-sign
